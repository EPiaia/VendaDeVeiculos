...
namespace VendaDeVeiculos.Telas
{
    public partial class RelatorioDeClientes : Form
    {
        ...
        private void RelatorioDeClientes_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                filtros.Add("cliNome", tbNome.Text.Trim());
            }
